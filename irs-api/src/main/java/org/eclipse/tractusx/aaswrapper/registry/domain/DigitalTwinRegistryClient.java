...
import org.eclipse.tractusx.services.OutboundMeterRegistryService;
...
class DigitalTwinRegistryClientImpl implements DigitalTwinRegistryClient {
    ...
    /* package */ DigitalTwinRegistryClientImpl(
            @Qualifier(RestTemplateConfig.OAUTH_REST_TEMPLATE) final RestTemplate restTemplate,
