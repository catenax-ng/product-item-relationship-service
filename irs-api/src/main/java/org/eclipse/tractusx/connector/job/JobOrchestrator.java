...
package org.eclipse.tractusx.connector.job;
...
public class JobOrchestrator<T extends DataRequest, P extends TransferProcess> {
     ...
     * @return response.
     */
    public JobInitiateResponse startJob(final org.eclipse.tractusx.dto.JobParameter jobData) {
        ...
        try {
            ...
            markJobInError(multiJob, e, IrsAppConstants.JOB_EXECUTION_FAILED);
    ...
    /* package */ void transferProcessCompleted(final P process) {
        ...
        try {
            ...
            markJobInError(job, e, IrsAppConstants.JOB_EXECUTION_FAILED);
            return;
        }
    ...
    private TransferInitiateResponse startTransfer(final MultiTransferJob job,
        ...
        final org.eclipse.tractusx.dto.JobParameter jobData = job.getJobParameter();
    ...
    private Job createJob(final String globalAssetId, final org.eclipse.tractusx.dto.JobParameter jobData) {
    ...
    private JobParameter buildJobParameter(final org.eclipse.tractusx.dto.JobParameter jobData) {
        return JobParameter.builder()
                           .depth(jobData.getTreeDepth())
                           .direction(Direction.DOWNWARD)
                           .aspects(jobData.getAspectTypes().stream().map(AspectType::fromValue)
                                                                     .collect(Collectors.toList()))
