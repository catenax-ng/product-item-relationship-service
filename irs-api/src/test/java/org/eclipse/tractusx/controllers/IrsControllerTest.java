package org.eclipse.tractusx.controllers;
...
import org.eclipse.tractusx.configuration.SecurityConfiguration;
import org.eclipse.tractusx.exceptions.EntityNotFoundException;
import org.eclipse.tractusx.services.IrsItemGraphQueryService;
...
class IrsControllerTest {
    ...
    private static Stream<RegisterJob> corruptedJobs() {
        return Stream.of(TestMother.registerJobWithDepthAndAspect(110, null),
                TestMother.registerJobWithGlobalAssetIdAndDepth("invalidGlobalAssetId", 0, null, false),
                TestMother.registerJobWithGlobalAssetIdAndDepth("urn:uuid:8a61c8db-561e-4db0-84ec-a693fc5\n\rdf6", 0, null,
                        false));
    }
    ...
    void initiateJobForGlobalAssetId() throws Exception {
        ...
        this.mockMvc.perform(post("/irs/jobs").contentType(MediaType.APPLICATION_JSON)
                                              .content(new ObjectMapper().writeValueAsString(
                                                      TestMother.registerJobWithoutDepthAndAspect())))
